...
<%@ Register src="../UserControls/ManageOrders.ascx" tagname="ManageOrders" tagprefix="uc3" %>
...
&nbsp;|
    ...
    <asp:Panel ID="Panel1" runat="server" Height="627px" BorderColor="#CC3300" 
        ...
        <asp:Panel ID="Panel2" runat="server" Height="27px" BackColor="#1376D7" 
            ...
            <span class="style2">Customer Orders</span>
            </asp:Panel>
        <p></p>
        <p>
            <table style="width:100%;">
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <uc3:ManageOrders ID="ManageOrders1" runat="server" />
                        <br />
                        <br />
